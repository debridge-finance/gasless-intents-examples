...
const CONTRACT_PATH = "contracts/direct-hooks/EchoWithSig.sol";
const CONTRACT_NAME = "EchoWithSig";
const POLL_INTERVAL_MS = 4_000;
const POLL_TIMEOUT_MS = 120_000;

const SOURCE_PATH = path.resolve(__dirname, "../../contracts/direct-hooks/EchoWithSig.sol");
const METADATA_PATH = path.resolve(__dirname, "../../build-artefacts/EchoWithSig_metadata.json");
