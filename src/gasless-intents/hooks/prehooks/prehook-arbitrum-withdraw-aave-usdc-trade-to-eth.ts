...
async function main() {
  ...
  // this is the amount that will be withdrawn from Aave in the pre-hook 
  // and swapped to ETH, adjust as needed
  const amountToRebalance = "1504714"; // 1.504714 USDC with 6 decimals 
