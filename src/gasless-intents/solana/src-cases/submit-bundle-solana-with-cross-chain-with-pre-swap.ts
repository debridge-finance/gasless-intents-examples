...
import {getSolUsdcToPolyUsdcTrade, getSolUsdtToPolyUsdcTrade} from "../../trades";
...
async function main() {
    ...
    const requestBody: BundleProposeBody = {
        ...
        trades: [
            getSolUsdtToPolyUsdcTrade("79bWNoaxKKAqSrFDDytJNXmLACL2GbKFg7qb6KKPCVxx", account.address),
        ],
        preHooks: [],
        postHooks: [],
    }
